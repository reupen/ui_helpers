...
void TextFormat::set_emoji_processing_config(std::optional<EmojiProcessingConfig> emoji_processing_config)
{
    ...
    auto icu_handle = m_context->get_icu();
    ...
    try {
        ...
        m_font_fallback = create_emoji_font_fallback(std::move(icu_handle), font_collection,
            std::move(system_font_fallback), emoji_processing_config->colour_emoji_family_name.c_str(),

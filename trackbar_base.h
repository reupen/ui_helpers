...
public:
     ...
     * \param [out]    p_out     Receives tooltip text, utf-8 encoded
     *
...
public:
     ...
     *
     * \param [in]    b_vertical    New vertically orientated state for track bar
     *
...
private:
     ...
     *
     * \param [in]    wnd           Specifies window receiving the message

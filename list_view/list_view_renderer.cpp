...
int ListView::measure_text_width(size_t index, size_t column)
{
    const char* str = get_item_text(index, column);
    return direct_write::measure_text_width_columns_and_styles(*m_items_text_format, mmh::to_utf16(str), 1_spx, 3_spx);
}

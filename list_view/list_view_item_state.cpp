...
t_size ListView::get_focus_item() {t_size ret = storage_get_focus_item(); if (ret >= get_item_count()) ret = pfc_infinite; return ret;}
...
//DEFAULT STORAGE
t_size ListView::storage_get_focus_item() {return m_focus_index;}

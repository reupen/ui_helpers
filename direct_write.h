...
public:
    ...
    void render(
        HDC dc, RECT rect, COLORREF default_colour, float x_origin_offset = 0.0f, float y_origin_offset = 0.0f) const;
    void render_with_background(HDC dc, RECT output_rect, RECT clip_rect, COLORREF background_colour,

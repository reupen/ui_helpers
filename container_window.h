...
namespace uih {
    namespace window_styles {
        ...
        constexpr const uint32_t style_popup_default = WS_SYSMENU | WS_POPUP | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | WS_CAPTION | WS_THICKFRAME;
    ...
    struct ContainerWindowConfig {
        ...
        ContainerWindowConfig(const wchar_t* class_name_)
